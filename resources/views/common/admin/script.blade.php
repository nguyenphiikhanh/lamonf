<script src="{{asset('minimals/assets/js/alpine-collaspe.min.js')}}"></script>
<script src="{{asset('minimals/assets/js/alpine-persist.min.js')}}"></script>
<script defer src="{{asset('minimals/assets/js/alpine-ui.min.js')}}"></script>
<script defer src="{{asset('minimals/assets/js/alpine-focus.min.js')}}"></script>
<script defer src="{{asset('minimals/assets/js/alpine.min.js')}}"></script>
<script src="{{asset('minimals/assets/js/custom.js')}}"></script>
<script defer src="{{asset('minimals/assets/js/apexcharts.js')}}"></script>
